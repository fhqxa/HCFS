...
%% Last modified by Shunxin with hierarchical SVM on 2020-12-8.
%% Input
...
%% Output
function [accuracyMean,accuracyStd,F_LCAMean,FHMean,TIEmean,RealLabel,PredLabel] = FS_Kflod_TopDownLevelSVMClassifierClu(data, numFolds,Clutree,feature,numberSel,indices)
[M,N]=size(data);
...
%      [trainDataMod,trainLabelMod,tree] = ClusterTreeguo(train_data);
    %% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Train classifiers of all internal levels    在每层训练一个model
